...
;	PICの初期化はあとで
	...
	MOV	AL, 0xff
	OUT	0x21, AL
	NOP				; OUTを連続してやるとうまくいかない環境があるらしい
	OUT	0xa1, AL

	CLI				; さらにCPUレベルでも割り込み禁止

; CPUから1MB以上のメモリにアクセスできるようにする(A20GATEの設定)
...
[INSTRSET "i486p"]			; 486の命令まで使いたいという記述
	...
	OR	EAX, 0x00000001		; bit 0を1にする(プロテクトモード移行)
	MOV	CR0, EAX
	JMP	pipelineflush
pipelineflush:
...
; asmheadでしなければいけないことは全部終わったので後はbootpackにまかせる
